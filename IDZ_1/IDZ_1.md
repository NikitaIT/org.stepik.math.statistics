...
<p align="right"><b>Выводы:</b></p>
<p align="right"><i>Значения выборки совпали с исходными(в задании),</i></p>
<p align="right"><i>но не совпали с вычисленными, видимо я <s>рукожоп</s> сгенерировал для них новое распределение</i></p>
----
